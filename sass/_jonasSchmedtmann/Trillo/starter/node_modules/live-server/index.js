#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/users/garethhind/.vscode/extensions/wallabyjs.console-ninja-0.0.206/out/buildhook/index.js').default({tool: 'live-server'}); } catch(cjsError) { try { import('file:///users/garethhind/.vscode/extensions/wallabyjs.console-ninja-0.0.206/out/buildhook/index.js').then(m => m.default.default({tool: 'live-server'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
